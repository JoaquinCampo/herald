...
After compression, changed logit signals reflect the model operating with less
context. They can be monitored alongside output quality, but this reference
does not prescribe a particular detection method.
