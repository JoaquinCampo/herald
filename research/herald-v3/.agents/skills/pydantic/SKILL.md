...
not commit the project to particular dependencies, models, or schema policies.
...
The most common errors Codex and other LLMs make with Pydantic. Full 28-item catalogue in `references/v1-to-v2-migration.md § 9`.
